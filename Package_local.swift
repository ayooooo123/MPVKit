...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libavcodec",
            path: "dist/release/Libavcodec.xcframework"
        ),
        .binaryTarget(
            name: "Libavdevice",
            path: "dist/release/Libavdevice.xcframework"
        ),
        .binaryTarget(
            name: "Libavformat",
            path: "dist/release/Libavformat.xcframework"
        ),
        .binaryTarget(
            name: "Libavfilter",
            path: "dist/release/Libavfilter.xcframework"
        ),
        .binaryTarget(
            name: "Libavutil",
            path: "dist/release/Libavutil.xcframework"
        ),
        .binaryTarget(
            name: "Libswresample",
            path: "dist/release/Libswresample.xcframework"
        ),
        .binaryTarget(
            name: "Libswscale",
            path: "dist/release/Libswscale.xcframework"
        ),
        ...
        .binaryTarget(
            name: "Libmpv",
            path: "dist/release/Libmpv.xcframework"
        ),
